...
export const Apartments = () => {
    ...
    return (
        <>
            ...
            <StyledText>
                <div onClick={() => showImage(`${imgFolder}/484b.jpg`)}>
                    <StyledSmallImage
                        src={rekreace_solary}
                        width="300"
                        height="225"
            ...
            <StyledText>
                <div onClick={() => showImage(`${imgFolder}/483b.jpg`)}>
                    <StyledSmallImage
            ...
            <StyledText>
                ...
                <ul>
                    ...
                    <li>Přízemí s výhledem do zahrady</li>
                    <li>
                        Dva samostatné pokoje, samostatná koupelna, manželská
                        postel, možnost přistýlky
                    </li>
                    <li>Zahradní posezení, slunečník</li>
                </ul>
            ...
            <StyledText>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <b>
                            (strmější schodiště, méně vhodné pro starší osoby)
                        </b>
                    </li>
                    <li>
                        Dva samostatné pokoje, samostatná koupelna, chodba
                        využita jako kuchyňka
                    </li>
            ...
            <StyledText>
                <ul>
                    ...
                    <li>
                        Každý apartmán se skládá ze dvou místností a samostatné
                        koupelny s WC. Součástí každého apartmá je: sociální
                        zařizení (umyvadlo, sprchový kout, WC), televize, rádio,
                        vybavený kuchyňský kout (vařič, lednice, dřez na nádobí,
                        kuchyňské nádobí, mikrovlná trouba, rychlovarná
                        konvice).
                    </li>
                    <li>
                        Úklid ubytovacích prostor se provádí jedenkrát týdně a
                        nebo na požádání.
                    </li>
                    <li>
                        Parkovací plochy pro tři automobily jsou na zahradě.
                    </li>
                    <li>
                        Je možno využívat zadní zahradu včetně posezení v
                        altánku. K apartmánům v přízemí přísluší venkovní
                        posezení (lavice, stůl, slunečník).
                    </li>
                    <li>
                        Kola, lyže a jiné sportovní a rybářské náčiní se ukládá
                        do kolárny, která se na noc zamyká.
                    </li>
