            ...
            <div className="text">
                <table className="table_ceny">
                    <tbody>
                        <tr>
                            <th colSpan={5}>
                                při zrušení zaplacené rekreace :
                            </th>
                        </tr>
                        <tr>
            ...
            <div className="text">
                <table className="table_ceny">
                    <tbody>
                        <tr>
                            <td>
                                Z důvodu bezpečí našich hostů neumožňujeme pobyt
                                domácích zvířat.
                                <br />V apartmá č. 2 je třetí lůžko formou
                                rozkládacího křesla.
                                <br />
                                Každé apartmá se skládá ze dvou samostatných
                                pokojů a koupelny.
                                <br />
                                Apartmány jsou určeny i pro dlouhodobou
                                rekreaci.
                                <br />
                                <b>
                                    V ceně je parkovné v objektu, wi-fi
                                    připojení na internet
                                    <br />a rekreační poplatek pro obec
                                    Frymburk.
                                </b>
                            </td>
                        </tr>
