...
export const Formular = ({
    ...
    return isCategory ? (
        ...
        <form ref={form} name="formular">
            <div className="photo_gallery_form_booking">
                <input
                    name="imgType"
                ...
                <input
                    ...
                    hidden
                />
                <div className="photo_gallery_photo_gallery">
                    <label>Název</label>
                    <input
                ...
                <div
                    className="photo_gallery_input_booking"
                    style={{ width: '40%' }}
                >
                ...
                <div className="photo_gallery_input_booking">
                    <label>Popis</label>
                    <textarea
                ...
                <div className="photo_gallery_submit_booking green">
                    <input
                        type="Submit"
                        onClick={(event) =>
                            editLogic(
                ...
                <div className="photo_gallery_submit_booking blue">
                    <input
                        type="Submit"
                        onClick={(event) =>
                            editLogic(
                ...
                <div
                    className="photo_gallery_submit_booking red"
