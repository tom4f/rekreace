...
export const Contact = () => {
    useEffect(() => {
        ...
        script.setAttribute('src', `${dev ? '' : ''}js/formular_kontakt.js`)
            ...
            <article className="maps">
                <section>
                    <img
                        ...
                        height="253"
                    />
                    <b>Městečko Frymburk</b> se nachází asi 50km na jih od
                    Českých Budějovic. Z Českých Budějovic do Frymburka se
                    dostanete následovně: Český Krumlov, Větřní, Světlík,
                    Blatná, Frymburk. Frymburk leží na břehu lipenského jezera a
                    7 km od hraničního přechodu s Rakouskem.
                    <br />
